...
const experiences = [
	{
		...
		description:
			"Participated in the TechSaksham Training Program, a joint CSR initiative by Microsoft and SAP, facilitated by Edunet Foundation. Over 100 hours (Feb - Mar 2025). I completed a certification in IR4.0 Technologies, mastering Linux, Advanced Python, SQL, and Data Analysis. The program included real-world project implementations and industry mentorship, significantly enhancing my data analytics skills and preparing me for practical tech applications.",
		skills: ["Python", "SQL", "Linux", "Data Analysis"],
	},
	{
		id: 2,
		startDate: "Jun 2025",
		...
		description:
			"Utilized machine learning models for Supply Chain and Inventory Optimization, achieving 94% accuracy in demand forecasting. Constructed and deployed a predictive maintenance model that reduced equipment downtime by 18%. Contributed to building and validating Privacy-Preserving Machine Learning (PPML) models.",
		skills: [
			"Machine Learning",
			"Power Apps",
			"Power Automate",
	...
	},
	{
		...
		location: "Gurugram, Haryana",
		description:
			"Authored and maintained core front-end components, boosting page load speed by 25% and refining user experience. Collaborated with cross-functional teams to deploy new features and optimize code, achieving a 15% reduction in API response time.",
